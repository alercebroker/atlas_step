...
from apf.db.sql import get_or_create, bulk_insert
...
class Atlas(GenericStep):
    ...
    **step_args : type
    ...
    def execute(self, message):
        schemavsn = message["schemavsn"]
        candidate = message["candidate"]
        objectID = message["objectID"]
        cutoutScience = message["cutoutScience"];
    ...
    def correct_message(self, message):
        #TODO: Revisar variables faltante
